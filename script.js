...
// const controlEl = formEl.querySelectorAll('.form-control')

// formEl.addEventListener('submit', (event) => {
//     for (let i = 0; i < controlEl.length; i++) {
//         if (controlEl[i].value == '') {
//             event.preventDefault();
//             controlEl[i].classList.add('error')
//             controlEl[i].style.borderColor = "blue";
//         }
//         controlEl.forEach(element => {
